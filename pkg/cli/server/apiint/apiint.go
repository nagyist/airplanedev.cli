...
import (
	...
	"github.com/airplanedev/cli/pkg/cli/resources/conversion"
	"github.com/airplanedev/cli/pkg/cli/resources/kind_configs"
	...
	"github.com/airplanedev/cli/pkg/cli/server/tasks"
	serverutils "github.com/airplanedev/cli/pkg/cli/server/utils"
	"github.com/airplanedev/cli/pkg/cli/server/views"
...
func SubmitPromptHandler(ctx context.Context, state *state.State, r *http.Request, req SubmitPromptRequest) (PromptResponse, error) {
	...
	userID := analytics.ParseTokenForAnalytics(state.RemoteClient.Token()).UserID
