...
import (
	...
	"github.com/airplanedev/cli/cmd/cli/agents"
	"github.com/airplanedev/cli/cmd/cli/apikeys"
	"github.com/airplanedev/cli/cmd/cli/auth"
	"github.com/airplanedev/cli/cmd/cli/auth/login"
	"github.com/airplanedev/cli/cmd/cli/auth/logout"
	"github.com/airplanedev/cli/cmd/cli/configs"
	"github.com/airplanedev/cli/cmd/cli/demo"
	"github.com/airplanedev/cli/cmd/cli/root/deploy"
	"github.com/airplanedev/cli/cmd/cli/root/initcmd"
	"github.com/airplanedev/cli/cmd/cli/runs"
	"github.com/airplanedev/cli/cmd/cli/tasks"
	"github.com/airplanedev/cli/cmd/cli/tasks/dev"
	"github.com/airplanedev/cli/cmd/cli/tasks/execute"
	"github.com/airplanedev/cli/cmd/cli/version"
...
func New() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
			...
			update.CheckLatest(cmd.Context(), &c)
