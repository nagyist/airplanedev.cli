...
func New(c *cli.Config) *cobra.Command {
	...
	cmd.Flags().BoolVar(&cfg.nonInteractive, "non-interactive", false, "Run the local Studio in non-interactive mode (when running in sandbox)")

	if err := cmd.Flags().MarkHidden("non-interactive"); err != nil {
